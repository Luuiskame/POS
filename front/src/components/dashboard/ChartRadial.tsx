...
const chartData = [
  ...
  { browser: "bebidas", visitors: 200, fill: "var(--chart-2)" },
  { browser: "limpieza", visitors: 187, fill: "var(--chart-3)" },
  { browser: "carnes", visitors: 173, fill: "var(--chart-4)" },
  ...
  return (
    <Card className="flex flex-col">
        ...
        >
          ...
          >
            <ChartTooltip
              cursor={false}
              content={(props) => (
                <ChartTooltipContent {...props} hideLabel nameKey="browser" />
              )}
            />
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        ...
        Mostrando los productos mas vendidos en la tienda
        </div>
      </CardFooter>
    </Card>
  )
